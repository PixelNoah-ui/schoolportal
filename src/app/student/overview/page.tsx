      ...
      <main className="flex flex-1 flex-col gap-6 bg-muted/20 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Link href="/student/results">
            <Card className="h-full rounded-none border-l-4 border-l-primary shadow-none transition-colors hover:border-primary">
          ...
          <Link href="/student/payments">
            <Card className="h-full rounded-none border-l-4 border-l-primary shadow-none transition-colors hover:border-primary">
              <CardContent className="p-6">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  View bank, mobile money, and cash payment options.
                </p>
              </CardContent>
            </Card>
          </Link>
