...
create policy if not exists "Admins can read classes"
on public.classes for select to authenticated
using (public.is_admin());
create policy if not exists "Admins can create classes"
...
using (public.is_admin())
with check (public.is_admin());
create policy if not exists "Admins can delete classes"
on public.classes for delete to authenticated
using (public.is_admin());

create policy if not exists "Admins can read subjects"
on public.subjects for select to authenticated
using (public.is_admin());
create policy if not exists "Admins can create subjects"
on public.subjects for insert to authenticated
with check (public.is_admin());
create policy if not exists "Admins can update subjects"
on public.subjects for update to authenticated
using (public.is_admin())
with check (public.is_admin());
create policy if not exists "Admins can delete subjects"
...
create policy if not exists "Admins can insert teachers"
on public.teachers for insert to authenticated
with check (public.is_admin());
create policy if not exists "Admins can update teachers"
on public.teachers for update to authenticated
using (public.is_admin())
with check (public.is_admin());
create policy if not exists "Admins can delete teachers"
on public.teachers for delete to authenticated
using (public.is_admin());

create policy if not exists "Admins can read academic years"
on public.academic_years for select to authenticated
using (public.is_admin());
create policy if not exists "Admins can manage academic years"
on public.academic_years for all to authenticated
using (public.is_admin())
with check (public.is_admin());

create policy if not exists "Admins can manage class subjects"
on public.class_subjects for all to authenticated
using (public.is_admin())
with check (public.is_admin());

create policy if not exists "Admins can manage grades"
on public.grades for all to authenticated
using (public.is_admin())
with check (public.is_admin());

create policy if not exists "Admins can read standings"
on public.academic_standings for select to authenticated
using (public.is_admin());
create policy if not exists "Admins can manage standings"
on public.academic_standings for all to authenticated
using (public.is_admin())
with check (public.is_admin());

create policy if not exists "Admins can manage rankings"
...
create policy if not exists "Admins can manage payment allocations"
